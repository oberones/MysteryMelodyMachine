...
def main(argv: Optional[list[str]] = None):
    ...
    midi_output = MidiOutput.create(cfg.midi.output_port, cfg.midi.channel)
    if midi_output:
    ...
    def handle_note_event(note_event: NoteEvent):
        ...
        if midi_output.is_connected:
            ...
            midi_output.send_note_on(note_event.note, note_event.velocity, cfg.midi.channel)
            # Schedule note off after duration
            note_scheduler.schedule_note_off(note_event.note, cfg.midi.channel, note_event.duration)
