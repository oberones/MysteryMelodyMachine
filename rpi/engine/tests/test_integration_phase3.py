...
from src.midi_out import MidiOutput, NullMidiOutput, get_available_output_ports
from src.main import NoteScheduler, ScheduledNoteOff
from src.sequencer import NoteEvent
...
class TestPhase3Integration:
    ...
    def test_engine_with_midi_output_disabled(self, mock_midi_output_class):
        ...
        from src.state import get_state, reset_state
        from src.sequencer import create_sequencer
        from src.main import NoteScheduler
        ...
        from src.midi_out import NullMidiOutput
        if not midi_output:
